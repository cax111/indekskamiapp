                        ...
                        <div class="card">
                            ...
                            <div class="content">
                                <form method="POST" action="">
                                    ...
                                    <?php echo e($errors->first('gagalInput')); ?>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <textarea rows="5" name="deskripsi" class="form-control border-input" placeholder="Isi dengan deskripsi ruang lingkup instansi (satuan kerja) dan infrastruktur TIK"><?php echo e(old('deskripsi')); ?></textarea>

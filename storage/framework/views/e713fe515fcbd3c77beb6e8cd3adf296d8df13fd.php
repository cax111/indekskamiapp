                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="isi_judul_instrument" class="form-control border-input" value="<?php echo e($judulInstrument->isi_judul_instrument); ?>" placeholder="Nama Judul Instrument.." required>

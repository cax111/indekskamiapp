                  ...
                  <table class="table table-striped">
                      ...
                      <tr>
                        ...
                        <td>
                          <div>
                            ...
                            <a class="btn btn-info" href="/tampil-detail-instrument/<?php echo e($tampil->id_instrument); ?>">Lihat Detail Instrument</a>
                            <a class="btn btn-warning" href="/ubah-instrument/<?php echo e($tampil->id_instrument); ?>">Ubah</a>
                            <a class="btn btn-danger" href="/hapus-instrument/<?php echo e($tampil->id_instrument); ?>"  onclick="return confirm('Apakah anda yakin menghapus instrument ini?')">Hapus</a>
                            <?php else: ?>
                            <a class="btn btn-info" href="/tampil-parameter/<?php echo e($tampil->id_instrument); ?>">Lihat Detail Instrument</a>
                    ...
                    <div class="col-md-12">
                      ...
                      <div style="margin:10px" class="stats">
                          ...
                          <?php if($id > 6): ?>
                          <a class="pull-right btn btn-success" href="/tambah-instrument/<?php echo e($id); ?>"><i class="ti-plus"></i> Tambah Instrument </a><p> </p>
